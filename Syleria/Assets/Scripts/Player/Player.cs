...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private float m_nRange = 5.0f;
    [SerializeField] private float m_nFireRate = 2.0f;
    [SerializeField] private float m_fSpeed = 5.0f;
    ...
    public float GetRange() {return this.m_nRange;}
    ...
    public void SetRange(float range) { this.m_nRange = range; }
    ...
    public void AddRange(float range) { this.m_nRange += range; }
